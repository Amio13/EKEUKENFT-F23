...
contract BasicNftTest is StdCheats, Test {
    string constant NFT_NAME = "Ekeuke";
    string constant NFT_SYMBOL = "EKE";
    BasicNft public basicNft;
    DeployBasicNft public deployer;
    address public deployerAddress;

    string public constant EKE_URI =
        "ipfs://QmcMpM5yyo7pLbAvaCGniePZrH3sXnxuwh6P87hm5b6wD3/?filename=0-ekeuke.json";
    ...
    function testTokenURIIsCorrect() public {
        ...
        assert(
            keccak256(abi.encodePacked(basicNft.tokenURI(0))) ==
                keccak256(abi.encodePacked(EKE_URI))
        );
    }
